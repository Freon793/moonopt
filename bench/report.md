...
Generated by `bench/report.ps1` from commit `7263ac0` (2026-09-20).
...
| --- | --- | --- | --- | --- |
| [parse-report.md](parse-report.md) | model file parsing (MPS/LP reader) | instances attempted: 33, parsed: 33, failed: 0 | `b338547` | STALE (15 changed since) |
| [solve-report.md](solve-report.md) | continuous kernel (LP relaxation, presolve, certificates) | instances in manifest: 32, solved to optimality: 20, skipped: 11, other outcomes: 1 | `315107f` | STALE (12 changed since) |
| [mip-report.md](mip-report.md) | branch and bound, 300-node budget over the whole manifest | instances in manifest: 32, proven optimal: 1, stopped at the node budget: 14, skipped: 17, relaxations verified by `verify`: 3932, cuts added and verified by `verify_cut`: 256 | `3ee797a` | STALE (10 changed since) |
| [mip-report-small.md](mip-report-small.md) | branch and bound, 20000-node budget over the small-instance list | instances in manifest: 10, proven optimal: 4, stopped at the node budget: 6, relaxations verified by `verify`: 134601, cuts added and verified by `verify_cut`: 176 | `4a4e002` | STALE (1 changed since) |
...
## Reports flagged stale

- bench/parse-report.md: generated at b338547, 15 file(s) under its own paths changed since - cmd/parse/main.mbt, cmd/parse/moon.pkg, cmd/parse/pkg.generated.mbti
- bench/solve-report.md: generated at 315107f, 12 file(s) under its own paths changed since - cmd/parse/main.mbt, cmd/parse/pkg.generated.mbti, simplex/certificate.mbt
- bench/mip-report.md: generated at 3ee797a, 10 file(s) under its own paths changed since - mip/cuts.mbt, mip/duals.mbt, mip/duals_wbtest.mbt
- bench/mip-report-small.md: generated at 4a4e002, 1 file(s) under its own paths changed since - mip/cuts.mbt
