...
Generated by `bench/report.ps1` from commit `59df81a` (2026-09-23).
...
| [mip-report.md](mip-report.md) | branch and bound, 300-node budget over the whole manifest | instances in manifest: 32, proven optimal: 1, stopped at the node budget: 14, skipped: 17, relaxations verified by `verify`: 4231, cuts added and verified by `verify_cut`: 266 | `59df81a` | current |
| [mip-report-small.md](mip-report-small.md) | branch and bound, 20000-node budget over the small-instance list | instances in manifest: 10, proven optimal: 4, stopped at the node budget: 6, relaxations verified by `verify`: 134601, cuts added and verified by `verify_cut`: 176 | `59df81a` | current |
