...
Generated by `bench/report.ps1` from commit `7a6a487` (2026-09-26).
...
| [mip-report.md](mip-report.md) | branch and bound, 300-node budget over the whole manifest | instances in manifest: 32, proven optimal: 3, stopped at the node budget: 12, skipped: 17, relaxations verified by `verify`: 3777, cuts added and verified by `verify_cut`: 325 | `7a6a487` | current |
| [mip-report-small.md](mip-report-small.md) | branch and bound, 20000-node budget over the small-instance list | instances in manifest: 10, proven optimal: 4, stopped at the node budget: 6, relaxations verified by `verify`: 134414, cuts added and verified by `verify_cut`: 205 | `7a6a487` | current |
