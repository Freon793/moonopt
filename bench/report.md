...
Generated by `bench/report.ps1` from commit `f904e8d` (2026-09-26).
...
| [mip-report.md](mip-report.md) | branch and bound, 300-node budget over the whole manifest | instances in manifest: 32, proven optimal: 2, stopped at the node budget: 13, skipped: 17, relaxations verified by `verify`: 4045, cuts added and verified by `verify_cut`: 315 | `f904e8d` | current |
| [mip-report-small.md](mip-report-small.md) | branch and bound, 20000-node budget over the small-instance list | instances in manifest: 10, proven optimal: 4, stopped at the node budget: 6, relaxations verified by `verify`: 134414, cuts added and verified by `verify_cut`: 205 | `f904e8d` | current |
