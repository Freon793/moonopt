...
但 Phase II 仍离收敛很远 —— 限制既不是内存也不是停滞，而是**每次枢轴的实际增益**：
实测 Phase I 的人工和从 489 起单调下降（500 / 1500 / 6000 次枢轴时分别是 267.9 / 150.1 / 17.4，
约 ×0.78 每 500 枢轴），Phase II 在 489 行的内核上从 20000 到 60000 次枢轴只把目标值从
165.115 降到 164.157（2.4e-5/枢轴）。这条边界的原因与量级见
